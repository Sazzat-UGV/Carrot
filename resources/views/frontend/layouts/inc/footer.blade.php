                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <a href="#" class="cr-payment-image">
                                        <img src="{{ asset('assets/frontend') }}/img/insta/1.jpg"
                                            alt="insta">
                                ...
                                <div class="swiper-slide">
                                    <a href="#" class="cr-payment-image">
                                        <img src="{{ asset('assets/frontend') }}/img/insta/2.jpg"
                                            alt="insta">
                                        <div class="payment-overlay"></div>
                                    </a>
                                </div>
                                <div class="swiper-slide">
                                    <a href="#" class="cr-payment-image">
                                        <img src="{{ asset('assets/frontend') }}/img/insta/3.jpg"
                                            alt="insta">
                                        <div class="payment-overlay"></div>
                                    </a>
                                </div>
                                <div class="swiper-slide">
                                    <a href="#" class="cr-payment-image">
                                        <img src="{{ asset('assets/frontend') }}/img/insta/4.jpg"
                                            alt="insta">
                                        <div class="payment-overlay"></div>
                                    </a>
                                </div>
                                <div class="swiper-slide">
                                    <a href="#" class="cr-payment-image">
                                        <img src="{{ asset('assets/frontend') }}/img/insta/5.jpg"
                                            alt="insta">
                                        <div class="payment-overlay"></div>
                                    </a>
                                </div>
                                <div class="swiper-slide">
                                    <a href="#" class="cr-payment-image">
                                        <img src="{{ asset('assets/frontend') }}/img/insta/6.jpg"
                                            alt="insta">
                                        <div class="payment-overlay"></div>
                                    </a>
                                </div>
                                <div class="swiper-slide">
                                    <a href="#" class="cr-payment-image">
                                        <img src="{{ asset('assets/frontend') }}/img/insta/7.jpg"
                                            alt="insta">
                                        <div class="payment-overlay"></div>
                                    </a>
                                </div>
                                <div class="swiper-slide">
                                    <a href="#" class="cr-payment-image">
                                        <img src="{{ asset('assets/frontend') }}/img/insta/8.jpg"
                                            alt="insta">
                                        <div class="payment-overlay"></div>
                                    </a>
                                </div>
