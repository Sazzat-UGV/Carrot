                        ...
                        <div class="col-12 col-md-6 mb-4">
                            ...
                            <input
                                class="form-control @error('title')
                                        is-invalid
                                    @enderror"
                                type="text" placeholder="Enter title" name="title" value="{{ old('title',$slider->title) }}">
                            @error('title')
                        ...
                        <div class="col-12 col-md-6 mb-4">
                            ...
                            <input
                                class="form-control @error('heading')
                                        is-invalid
                                    @enderror"
                                type="text" placeholder="Enter heading" name="heading" value="{{ old('heading',$slider->heading) }}">
                            @error('heading')
                                <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                            @enderror
                        </div>
                        ...
                        <div class="col-12 col-md-6 mb-4">
                            ...
                            <input
                                class="form-control @error('button_name')
                                        is-invalid
                                    @enderror"
                                type="text" placeholder="Enter button name" name="button_name" value="{{ old('button_name',$slider->button_name) }}">
                            @error('button_name')
                                <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                            @enderror
                        </div>
                        <div class="col-12 col-md-6 mb-4">
                            ...
                            <input
                                class="form-control @error('button_link')
                                        is-invalid
                                    @enderror"
                                type="text" placeholder="Enter button link" name="button_link" value="{{ old('button_link',$slider->button_link) }}">
                            @error('button_link')
                                <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                            @enderror
                        </div>
                        <div class="col-12 mb-4">
                            ...
                            <input
                                class="form-control dropify @error('image')
                                        is-invalid
                                    @enderror"
                                type="file" name="image" data-default-file="{{ asset('uploads/slider') }}/{{ $slider->image }}">
                            @error('image')
