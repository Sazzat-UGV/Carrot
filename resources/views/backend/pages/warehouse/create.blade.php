                        ...
                        <div class="col-6 mb-4">
                            ...
                            <input
                                class="form-control @error('warehouse_name')
                                        is-invalid
                                    @enderror"
                                type="text" placeholder="Enter warehouse name" name="warehouse_name" value="{{ old('warehouse_name') }}">
                        ...
                        <div class="col-6 mb-4">
                            ...
                            <input
                                class="form-control @error('warehouse_phone')
                                        is-invalid
                                    @enderror"
                                type="text" placeholder="Enter warehouse phone" name="warehouse_phone" value="{{ old('warehouse_phone') }}">
                        ...
                        <div class="col-12 mb-4">
                            ...
                            <input
                                class="form-control @error('warehouse_address')
                                        is-invalid
                                    @enderror"
                                type="text" placeholder="Enter warehouse address" name="warehouse_address" value="{{ old('warehouse_address') }}">
