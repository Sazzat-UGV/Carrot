...
@section('content')
    <div class="row">
        <div class="col-12 col-md-12">
            <div class="card">
                <h5 class="card-header">Edit Pickup Point</h5>
                <div class="card-body">
                    <div class="row mb-3">
                        <div class="col-sm-12">
                            <div class="">
                    ...
                    <form action="{{ route('admin.pickup-point.update', $pickup_point->id) }}" method="POST"
                        ...
                        <div class="row">
                            <div class="col-12  mb-4">
                                ...
                                <input
                                    ...
                                    value="{{ old('name', $pickup_point->name) }}">
                                @error('name')
                            ...
                            <div class="col-12 col-md-6 mb-4">
                                ...
                                <input
                                    ...
                                    value="{{ old('primary_phone', $pickup_point->primary_phone) }}">
                                @error('primary_phone')
                                    <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                                @enderror
                            </div>
                            <div class="col-12 col-md-6 mb-4">
                                ...
                                <input
                                    ...
                                    value="{{ old('secondary_phone', $pickup_point->secondary_phone) }}">
                            ...
                            <div class="col-12 mb-4">
                                ...
                                <input
                                    ...
                                    value="{{ old('address', $pickup_point->address) }}">
                                @error('address')
                                    <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                                @enderror
                            </div>
