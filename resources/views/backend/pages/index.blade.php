                    ...
                    <div class="table-responsive text-nowrap">
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><i class="fab fa-vuejs fa-xl text-success me-4"></i> <span>VueJs Project</span>
                                    </td>
                                    <td>Trevor Baker</td>
                                    <td>
                                        <ul class="list-unstyled m-0 avatar-group d-flex align-items-center">
                                            ...
                                            <li data-bs-toggle="tooltip" data-popup="tooltip-custom"
                                                data-bs-placement="top" class="avatar avatar-xs pull-up"
                                                aria-label="Sophia Wilkerson" data-bs-original-title="Sophia Wilkerson">
                                                <img src="{{ asset('assets/backend') }}/img/avatars/6.png" alt="Avatar"
                                                    class="rounded-circle">
                                            </li>
                                            <li data-bs-toggle="tooltip" data-popup="tooltip-custom"
                                ...
                                <tr>
                                    <td><i class="fab fa-bootstrap fa-xl text-primary me-4"></i> <span>Bootstrap
                                            Project</span>
                                    </td>
                                    <td>Jerry Milton</td>
                                    <td>
