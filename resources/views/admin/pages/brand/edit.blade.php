                                ...
                                <div class="mb-3 col-12">
                                    <div class="mb-3">
                                        ...
                                        <div class="dropdown bootstrap-select default-select form-control wide dropup">
                                            <select name="status"
                                                class="default-select form-control wide @error('status') is-invalid @enderror"
                                                tabindex="null">
                                                <option value="1"
                                                    {{ old('status', $brand->is_active) == 1 ? 'selected' : '' }}>Active
                                                </option>
                                                <option value="0"
                                                    {{ old('status', $brand->is_active) == 0 ? 'selected' : '' }}>Deactive
                                                </option>
                                            </select>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="file"
                                            class="form-control dropify @error('image')
                                                is-invalid
                                            @enderror"
                                            name="image" data-height="230"
                                            data-default-file="{{ asset('uploads/brand_logo') }}/{{ $brand->brand_logo }}">
                                        @error('image')
                                            <span class="invalid-feedback"
                                                role="alert"><strong>{{ $message }}</strong></span>
                                        @enderror
