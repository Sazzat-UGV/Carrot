                                            ...
                                            <div class="row">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <div
                                                            class="dropdown
                                                             wide dropup">
                                                            <select
                                                                class="form-control wide @error('child_category') is-invalid @enderror"
                                                                id="child_category" value="{{ old('child_category') }}"
                                                        ...
                                                        @enderror "
                                                                ...
                                                                @foreach ($pickup_points as $pickup_point)
                                                                    <option value="{{ $pickup_point->id }}"
                                                                        @if (old('pickup_point') == $pickup_point->id) selected @endif>
                                                ...
                                                <div class="col-12">
                                                    <div class="mb-3">
                                                        ...
                                                        is-invalid
                                                    @enderror"
                                                            name="product_details" id="editor" placeholder="enter product details" rows="4" id="comment">{{ old('product_details') }}</textarea>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                @enderror"
                                                        ...
                                                        @if (old('featured_product')) checked @endif>
                                            ...
                                            <div class="mb-3">
                                                <div class="form-check form-switch">
                                                    ...
                                                    <input
                                                        class="form-check-input  @error('today_deal')
                                                    is-invalid
                                                @enderror"
                                                        type="checkbox" id="today_deal" name="today_deal"
                                                        @if (old('today_deal')) checked @endif>
                                                    @error('today_deal')
                                                        <span class="invalid-feedback"
                                                            role="alert"><strong>{{ $message }}</strong></span>
                                                    @enderror
