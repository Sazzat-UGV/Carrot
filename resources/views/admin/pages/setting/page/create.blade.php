                    ...
                    <div class="basic-form">
                        <form action="{{ route('page.store') }}" method="POST">
                            ...
                            <div class="row">
                                ...
                                is-invalid
                            @enderror"
                                        placeholder="Enter page name" name="page_name" value="{{ old('page_name') }}">
                                    @error('page_name')
                                        <span class="invalid-feedback"
                                            role="alert"><strong>{{ $message }}</strong></span>
                                    @enderror
                            ...
                            @enderror"
                                ...
                                <div class="mb-3 col-12">
                                    ...
                                    is-invalid
                                @enderror"
                                        name="page_description" id="editor" placeholder="enter page description" rows="4" id="comment">{{ old('page_description') }}</textarea>
