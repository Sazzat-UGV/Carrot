            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="basic-form">
                        <form action="{{ route('subcategory.update', ['subcategory' => $subcategory->id]) }}"
                            method="POST">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="dropdown bootstrap-select default-select form-control wide dropup">
                                            <select name="category_name"
                                                class="default-select form-control wide @error('category_name') is-invalid @enderror"
                                                tabindex="null">
                                                @foreach ($categories as $category)
                                                    <option value="{{ $category->id }}"
                                                        @if ($category->id == $subcategory->category_id) selected @endif
                                                        @if (old('category_name', $subcategory->category_id) == $category->id) selected @endif>
